...
(function ($) {
	...
	var Module = function Module(element, opt) {
		this.ele = element;
		this.$ele = $(element);
	...
	$.fn[ModuleName] = function (options, options2) {
		return this.each(function () {
			...
			if (!!module) {
				...
				opts = $.extend({}, Module.DEFAULTS, (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' && options, (typeof options2 === 'undefined' ? 'undefined' : _typeof(options2)) === 'object' && options2);
